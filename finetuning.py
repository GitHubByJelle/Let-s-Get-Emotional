...
# Get correct loader
if loader_type == 'balanced_transform': # Data will be balanced and horizontally flipped
    ...
    trainloader, valloader, testloader, plotloader = loaders.make_loader_small(batch_size)

# Define dict for loaders
...
# Plot the results (only the val accuracy)
